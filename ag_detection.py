...
def get_dataloader(s, c, fold, transform_index, minibatch_size):
  ...
  transformed_Dataset = AdienceDataset(txt_file, root_dir, transform.Compose(transforms_dict[s][transform_index]))
...
PATH_TO_MODELS = "/content/age-and-gender-classification/models"
...
PATH_TO_AGE_MODEL = '/content/age-and-gender-classification/models/age.pt'
PATH_TO_GENDER_MODEL = '/content/age-and-gender-classification/models/gender.pt'
