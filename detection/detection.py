...
def main():
    ...
    dst_image=sys.argv[1]
    mix_image=sys.argv[2]
    known_image = face_recognition.load_image_file(dst_image)
    unknown_image = face_recognition.load_image_file(mix_image)
